GX._DATAS_ = {
	...
	pageUrls:{
		'1':{link:'tradingStatementShipping.html', icon:'img/ic_mainmenu_01.png', groupTitle:'제품추적관리', subTitle:'Trading statement Shipping'},//명세입고처리_TDI
		'2':{link:'inventoryInspection.html', icon:'img/ic_mainmenu_02.png', groupTitle:'제품추적관리', subTitle:'Inventory inspection'}, //재고실사등록_TDI
		// '3':{link:'specificationShipmentProcessing.html', icon:'img/ic_mainmenu_03.png', groupTitle:'제품추적관리', subTitle:'명세출고처리'}, 
		...
		// // '8':{link:'test.html', icon:'img/ic_mainmenu_09.png', groupTitle:'제품추적관리', subTitle:'데이터관리'},
...
if(false){
	...
	if(GX.Storage.data.hasOwnProperty('gx_serverAddr')){
		...
		if(GX.Storage.get('gx_serverAddr') == 'http://192.168.205.20:8113') GX._DATAS_.ajaxHeaders.guid = 'CB211D39-F77E-E111-BDAF-0010182FC8D5';
		else if(GX.Storage.get('gx_serverAddr') == 'http://14.48.238.61:8113') GX._DATAS_.ajaxHeaders.guid = '4CB521B9-3ACC-DF11-A3B6-001A6424E3C6';
	}
